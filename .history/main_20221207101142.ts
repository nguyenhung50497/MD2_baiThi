...
let ny2 = new GirlFriend(2, 'Thương', 'Nam Định', 'Bạch Dương', 1997, 'zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz');
...
function searchByName() {
    ...
    cốndisplay(gFManager.findByNameContaining(name));
}
