...
let ny1 = new GirlFriend(1, 'Hân', 'Nam Định', 'Bạch Dương', 1997, 'zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz');
let ny2 = new GirlFriend(2, 'Thương', 'Nam Định', 'Bạch Dương', 1997, 'adahsdsádấđassadád');
let ny3 = new GirlFriend(3, 'Linh', 'Nam Định', 'Bạch Dương', 1997, 'adahsdsádấđassadád');
let ny4 = new GirlFriend(4, 'Hoa', 'Nam Định', 'Bạch Dương', 1997, 'adahsdsádấđassadád');
