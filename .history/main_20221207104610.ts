...
let nY1 = new GirlFriend(3, 'Linh', 'Nam Định', 'Bạch Dương', 1997, 'Xây dựng chức năng  cập nhật thông tin  người yêu với dữ liệu đầu vào');
let nY1 = new GirlFriend(4, 'Hoa', 'Nam Định', 'Bạch Dương', 1997, 'Xây dựng chức năng  cập nhật thông tin  người yêu với dữ liệu đầu vào');
